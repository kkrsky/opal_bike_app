  ...
  actions: {
    ...
    checState_location_init({ state, commit }) {
      ...
      if (state.isDiagnostic && state.isDevice) {
        ...
        commit("isLocationAvailable");
        commit("isLocationEnabled");
        commit("isLocationAuthorized");
        commit("getLocationAuthorizationStatus");
        commit("registerLocationStateChangeHandler");
        //requestLocationAuthorization

        if (state.deviceInfo.platform === "android") {
          //android
          commit("getLocationMode_android");
          commit("isGpsLocationAvailable_android");
          commit("isGpsLocationEnabled_android");
          commit("isNetworkLocationAvailable_android");
          commit("isNetworkLocationEnabled_android");
