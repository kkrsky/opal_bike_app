<template>
  <div id="UserShareHeader">
    <v-avatar class="user-avatar">
      <v-img :src="userItems.displayAvatar"></v-img>
    </v-avatar>
    <div class="user-name">
      <span>{{ userItems.displayName }}</span>
    </div>
    <div class="user-description">
      <span>{{ userItems.displayDescription }}</span>
    </div>
  </div>
</template>
...
#UserShareHeader {
  ...
  grid-template:
    "avatar user-name    " 50%
    "avatar description " 50%
    / #{$__user-share-header-height} 1fr;
  ...
  .user-avatar {
    grid-area: avatar;
    height: $__user-share-header-height * $avatar-size__adjust !important;
    width: $__user-share-header-height * $avatar-size__adjust !important;
    min-width: $__user-share-header-height * $avatar-size__adjust !important;
