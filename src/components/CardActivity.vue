      ...
      <v-row dense>
        ...
        >
          <v-card>
            ...
            <v-card-actions class="activity-map-container"
              ><v-img
              ...
              >
                <v-card-title
                  v-text="cardItem.userCustomize.title"
                ></v-card-title> </v-img
            ></v-card-actions>
            <v-card-actions class="activity-data-container">
              <!-- 走行時間 -->
            ...
            <v-card-actions class="activity-action-container">
              <v-spacer></v-spacer>
